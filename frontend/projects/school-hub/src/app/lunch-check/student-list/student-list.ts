...
export class StudentListComponent {
  ...
  readonly selectedRecord = input<StudentLunchCheckCompositeRecord | null>(null);
  ...
  isSelected(record: StudentLunchCheckCompositeRecord): boolean {
    return this.selectedRecord()?.student.id === record.student.id;
  }
}
